...
## About:
  * Homepage: https://krokoyr.github.io/memo_game/
  ...
  * Currently it has several actions:
    ...
    * If user selects 2 tiles with different colors then they are flipped to "closed" state, and user proceeds with the next round. 
